...
builder.Services.AddSingleton<ParserService>(provider =>
{
    return new ParserService(logger, watcherPath, verticaConnection);
});
...
var watcherService = app.Services.GetRequiredService<ParserService>();
